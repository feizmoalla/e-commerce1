...
import com.tp.jee.ecommerce.repository.ProductRepository;
...
public class ProductService {
    ...
    public List<Product> getAllProductsByCategoryId(int id) {return productRepository.findAllByCategoryId(id);}
}
